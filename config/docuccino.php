...
return [
    ...
    */
    ...
    'documents' => [
        ...
        'default' => [
            ...
            // 'default' documents the framework's own JSON error shapes for the exceptions it renders
            // itself, 'none' emits no error responses. What your own handlers return is read either way.
    ...
    */
    ...
    'lint' => [
        ...
        // (password/token/secret/api_key…), and when a published example, const, enum or default
        ...
        'leakage' => [
            ...
            // Key = a token matched anywhere inside a property or parameter name, value = the label.
