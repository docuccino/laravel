...
namespace Docuccino\Laravel\Tests\Fixtures\Versioning\OptionalRequestPairReversed;
...
/**
 * Two fields of one request body, written subtitle first. Its twin in `OptionalRequestPair` writes the same
...
final class ArticleSubtitleAndAuthorBecameOptional {}
